...
class _WebNavWidgetState extends State<WebNavWidget>
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        width: _model.compactView! ? 120.0 : 270.0,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                        ...
                        if (_model.compactView == false)
                          Container(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_NAV_format_indent_decrease_ICN_ON_TA');
                        ...
                        if (_model.compactView == true)
                          Container(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'WEB_NAV_format_indent_increase_ICN_ON_TA');
                    ...
                    if (_model.compactView == true)
                      Container(
                        ...
                        child: wrapWithModel(
                          model: _model.mainLogoCompactModel,
                          updateCallback: () => safeSetState(() {}),
                          child: MainLogoCompactWidget(),
                        ),
                      ),
                    Column(
                      mainAxisSize: MainAxisSize.max,
              ...
              if (valueOrDefault(currentUserDocument?.role, '') == 'azienda')
                Padding(
