...
import 'modal_create_info_a_i_model.dart';
export 'modal_create_info_a_i_model.dart';

class ModalCreateInfoAIWidget extends StatefulWidget {
  const ModalCreateInfoAIWidget({super.key});

  @override
  State<ModalCreateInfoAIWidget> createState() =>
      _ModalCreateInfoAIWidgetState();
}

class _ModalCreateInfoAIWidgetState extends State<ModalCreateInfoAIWidget>
    with TickerProviderStateMixin {
  late ModalCreateInfoAIModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalCreateInfoAIModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'tq56gdpd' /* Crea un nuovo calendario */,
                      ),
                                    ...
                                    child: Container(
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            '7630utlr' /* Preavviso annullamento */,
                                          ),
                                          labelStyle: FlutterFlowTheme.of(
                                                  context)
                                              .labelMedium
                      ...
                      children: [
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MODAL_CREATE_INFO_A_I_CANCEL_BTN_ON_TAP');
