...
import 'modal_onboarding_dati_personali_model.dart';
export 'modal_onboarding_dati_personali_model.dart';

class ModalOnboardingDatiPersonaliWidget extends StatefulWidget {
  const ModalOnboardingDatiPersonaliWidget({super.key});

  @override
  State<ModalOnboardingDatiPersonaliWidget> createState() =>
      _ModalOnboardingDatiPersonaliWidgetState();
}

class _ModalOnboardingDatiPersonaliWidgetState
    extends State<ModalOnboardingDatiPersonaliWidget>
    with TickerProviderStateMixin {
  late ModalOnboardingDatiPersonaliModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalOnboardingDatiPersonaliModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MODAL_ONBOARDING_DATI_PERSONALI_modal_on');
    });
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'gvf5zf0u' /* Informazioni Personali */,
                      ),
                      style:
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        't269cdns' /* Completa il tuo profilo */,
                      ),
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => TextFormField(
                              ...
                              cursorColor: FlutterFlowTheme.of(context).primary,
                              validator: _model.cognomeTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'MODAL_ONBOARDING_DATI_PERSONALI_Row_mlw3');
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) =>
                              ...
                              future: FFAppState().comuni(
                                requestFn: () =>
                                    ComuniITAGroup.comuniCall.call(),
                              ),
                        ...
                        Align(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MODAL_ONBOARDING_DATI_PERSONALI_Button_6');
