...
import 'main_aggiungi_informazioni_model.dart';
export 'main_aggiungi_informazioni_model.dart';

class MainAggiungiInformazioniWidget extends StatefulWidget {
  const MainAggiungiInformazioniWidget({super.key});

  @override
  State<MainAggiungiInformazioniWidget> createState() =>
      _MainAggiungiInformazioniWidgetState();
}

class _MainAggiungiInformazioniWidgetState
    extends State<MainAggiungiInformazioniWidget>
    with TickerProviderStateMixin {
  late MainAggiungiInformazioniModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainAggiungiInformazioniModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Main_Aggiungi_Informazioni'});
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'slnbqqj4' /* Aggiungi Informazioni */,
                                      ),
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'MAIN_AGGIUNGI_INFORMAZIONI_search_rounde');
                                        ...
                                        children: [
                                          Expanded(
                                            child: Container(
                                              child: TextFormField(
                                                controller:
                                                    _model.titoloTextController,
                                                focusNode:
                                                    _model.titoloFocusNode,
                                                autofocus: true,
                                                obscureText: false,
                                          ...
                                          Expanded(
                                            child: Container(
                                              child: TextFormField(
                                                controller: _model
                                                    .contenutoTextController,
                                                focusNode:
                                                    _model.contenutoFocusNode,
                                                autofocus: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'm7w409rk' /* Preavviso annullamento */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Container(
                                              child: TextFormField(
                                                controller:
                                                    _model.cityTextController6,
                                                focusNode:
                                                    _model.cityFocusNode6,
                                                autofocus: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
