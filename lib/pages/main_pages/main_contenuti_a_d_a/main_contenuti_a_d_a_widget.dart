...
import 'main_contenuti_a_d_a_model.dart';
export 'main_contenuti_a_d_a_model.dart';

class MainContenutiADAWidget extends StatefulWidget {
  const MainContenutiADAWidget({super.key});

  @override
  State<MainContenutiADAWidget> createState() => _MainContenutiADAWidgetState();
}

class _MainContenutiADAWidgetState extends State<MainContenutiADAWidget>
    with TickerProviderStateMixin {
  late MainContenutiADAModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainContenutiADAModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Main_contenuti_ADA'});
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (responsiveVisibility(
                          ...
                          Builder(
                            builder: (context) => FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MAIN_CONTENUTI_A_D_A_AGGIUNGI_INFORMAZIO');
                                await showDialog(
                              ...
                              text: FFLocalizations.of(context).getText(
                                'w8w6mm67' /* Aggiungi Informazioni */,
                              ),
                        ...
                        if (responsiveVisibility(
                          ...
                          Builder(
                            builder: (context) => FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MAIN_CONTENUTI_A_D_A_CARICA_C_S_V_BTN_ON');
                                await showDialog(
                                  barrierColor: Colors.transparent,
                                  context: context,
                                  builder: (dialogContext) {
                        ...
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'MAIN_CONTENUTI_A_D_A_search_rounded_ICN_');
                              ...
                              children: [
                                StickyHeader(
                                  ...
                                  content: FutureBuilder<ApiCallResponse>(
                                    future:
                                        ADAapiGroup.getAllCustomBotCall.call(
                                      token: '789',
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      final listViewGetAllCustomBotResponse =
                                          snapshot.data!;
                                      ...
                                      return Builder(
                                        builder: (context) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemCount: recordCustomBot.length,
                                            itemBuilder: (context,
                                                recordCustomBotIndex) {
                                              final recordCustomBotItem =
                                                  recordCustomBot[
                                                      recordCustomBotIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                            ...
                                                            builder:
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'MAIN_CONTENUTI_A_D_A_Icon_o63ehjfy_ON_TA');
