                                  ...
                                  children: [
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'MAIN_CALENDAR_search_rounded_ICN_ON_TAP');
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'pjhp974a' /* No-Code Platform Design */,
                                                    ),
                                ...
                                Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MAIN_CALENDAR_Container_g7rtpf6m_ON_TAP');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '7oxu5rjm' /* Contracts for New Opportunitie... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium
                                ...
                                Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MAIN_CALENDAR_Container_0z0fnjff_ON_TAP');
                                        if (MediaQuery.sizeOf(context).width >=
                                            991.0) {
                                          await showDialog(
                                            barrierColor:
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '86balvhp' /* Client Acquisition for Q3 */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium
