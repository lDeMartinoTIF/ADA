                                          ...
                                          StickyHeader(
                                                        ...
                                                        child: Align(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'lqm09c6v' /* Preavviso Annullamento */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium
                                            ...
                                            content:
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                final listViewGetAllTipiServizioResponse =
                                                    snapshot.data!;
                                                  ...
                                                  builder: (context) {
                                                    final itemTipoServizio =
                                                        ADAapiGroup
                                                            .getAllTipiServizioCall
                                                            .jspAllData(
                                                              listViewGetAllTipiServizioResponse
                                                                  .jsonBody,
                                                            )
                                                            .toList();
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_CONFIGURAZIONE_SERVIZI_Icon_5p78u36');
                                                                            await showAlignedDialog(
                                                                              barrierColor: Colors.transparent,
                                                                              context: context,
                                                                              isGlobal: false,
